...
function createEngine({ regex = exports.DefaultRegExp, nullHandler = exports.DefaultOnNullText, variableHandler = exports.DefaultHandleVars, encoding = 'utf8' }) {
...
function render(input, data, { regex = exports.DefaultRegExp, nullHandler = exports.DefaultOnNullText, variableHandler = exports.DefaultHandleVars, }) {
    let renderedStr = renderText(input, data, regex, nullHandler, variableHandler);
    return renderedStr;
}
exports.render = render;
async function renderFile(filePath, data, { regex = exports.DefaultRegExp, nullHandler = exports.DefaultOnNullText, variableHandler = exports.DefaultHandleVars, encoding = 'utf8', }, callback = (c) => { }) {
    fs_1.default.promises.readFile(filePath).then((content) => {
        if (!Buffer.isEncoding(encoding)) {
            encoding = 'utf8';
        }
